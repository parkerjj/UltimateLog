...
PRIV_KEY = "c6fdc646dd68a713e738df5be6e65957a58f564dae0feefb307adf033d133bec"
PUB_KEY = "e6100b8dfa5bf79130873aa319e13321c576940ade02f4f774937619e22e1f51125c81ba146176d2f98a5841006cbee1ffe82a84c0f91fa3077fbbb356c6f66f"
...
def DecodeBuffer(_buffer, _offset, _outbuffer):
    ...
    try:
        ...
        if MAGIC_NO_COMPRESS_START1==_buffer[_offset]:
            ...
            cpubkey = client.get_pubkey()
            tea_key = svr.get_ecdh_key(cpubkey)
